...
|-------------------|-----------------------------------|:-----------------:|
| `plot_hist()`, `love.plot()` and `assess_overlap()` | Evaluates and visualizes the overlap in propensity scores and covariate balance between treated and control groups.                                                             |             More              |
