...
## Estimating the Effects of Big Contracts on Price markups
gc()
rm(list = ls())
...
pdf("graphs/s1_odds.pdf", width = 5.5, height = 5.5)
plot_hist(s, "ps", "tr", breaks = 30, odds = TRUE, xlim = c(-5.5, 1), ylim = c(-0.4, 0.4))
graphics.off()



pdf("graphs/s1_odds_trim.pdf", width = 5.5, height = 5.5)
s2$ps <- probability_forest(X = s2[, covar], 
...
pdf("graphs/s1_dyn.pdf", width = 7, height = 5)
par(mar = c(4, 4, 1, 2))
...
pdf("graphs/s1_dyn2.pdf", width = 7, height = 5)
par(mar = c(4, 4, 1, 2))
plot(1, xlim = c(0.7, 4.3), ylim = c(-.1, .2), type = "n", axes = FALSE, 
     ylab = "Effects on Markups (percentage)", xlab = "Year Relative to Contract 2017-2021")
box(); axis(2)
...
legend("bottomleft", legend = c("DIM,  Full (390 : 467)", "AIPW, Full (390 : 467)", 
                              "AIPW, PS Matched (208 : 208)"), lwd = 2,
...
pdf("graphs/s1_catt.pdf", width = 7, height = 5)
par(mar = c(4, 4, 1, 2))
plot(1, xlim = c(0.7, 4.7), ylim = c(-2, 2), type = "n", axes = FALSE, 
...
pdf("graphs/s1_catt_trim.pdf", width = 7, height = 5)
par(mar = c(4, 4, 1, 2))
plot(1, xlim = c(0.7, 4.7), ylim = c(-2, 2), type = "n", axes = FALSE, 
     ylab = "Effects on Markups (percentage)", xlab = "Year Relative to Contract")
box(); axis(2)
...
covar <- c("year", "pp_history","dpp_mean", "sales", "costs", "assets", "wages", "empl", "nace2", "sector", "x1", "x2","x3")
hist(s2$xmu.avg, breaks = 50)
hist(s2$ymu.avg, breaks = 50)
...
save(qte.irs.pre.unadj, qte.irs.pst.unadj, qte.irs.pre.trim.unadj, qte.irs.pst.trim.unadj,
     qte.irs.pre.adj, qte.irs.pst.adj, qte.irs.pre.trim.adj, qte.irs.pst.trim.adj, file = "output/qte_s1.rds")
...
load("output/qte_s1.rds")

pdf("graphs/s1_qte_pre.pdf", width = 6, height = 5)
ylim <- c(-.1, .3)
plot_qte(qte.irs.pre.adj, qte.irs.pre.unadj, ylim = ylim, main = "Pre-Winning Avg. Markup")
legend("bottomleft", legend = c("Unadjusted", "Adjusted"), 
       lty = 1, pch = c(17, 16), col = c(2, 1), bty = "n")
graphics.off()

pdf("graphs/s1_qte_pst.pdf", width = 6, height = 5)
plot_qte(qte.irs.pst.adj, qte.irs.pst.unadj, ylim = ylim, main = "Post-Winning Avg. Markup")
legend("bottomleft", legend = c("Unadjusted", "Adjusted"), 
       lty = 1, pch = c(17, 16), col = c(2, 1), bty = "n")
graphics.off()


pdf("graphs/s1_qte_pre_trim.pdf", width = 6, height = 5)
plot_qte(qte.irs.pre.trim.adj, qte.irs.pre.unadj, ylim = ylim, main = "Pre-Winning Avg. Markup")
legend("bottomleft", legend = c("Unadjusted", "Adjusted"), 
       lty = 1, pch = c(17, 16), col = c(2, 1), bty = "n")
graphics.off()

pdf("graphs/s1_qte_pst_trim.pdf", width = 6, height = 5)
plot_qte(qte.irs.pst.trim.adj, qte.irs.pst.unadj, ylim = ylim, main = "Post-Winning Avg. Markup")
legend("bottomleft", legend = c("Unadjusted", "Adjusted"), 
       lty = 1, pch = c(17, 16), col = c(2, 1), bty = "n")
graphics.off()
