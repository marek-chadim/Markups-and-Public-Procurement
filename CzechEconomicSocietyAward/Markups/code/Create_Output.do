...
sort year
scatter MARKUP_AGG MARKUP_AGG_w year, c(l) lcolor(red ) lpattern(solid) symbol(none) lwidth(thick) ytitle("") xlabel(2006 2009 2012 2015 2018 2021) xtitle("") legend(ring(0)  pos(2) ) 
graph export Fig1.png, replace
scatter MARKUP_AGG MARKUP_AGG_w year, c(l) lcolor(black ) lpattern(solid) symbol(none) lwidth(thick) ytitle("") xlabel(2006 2009 2012 2015 2018 2021) xtitle("") legend(ring(0)  pos(2) ) 
...
scatter elasticity_W COSTSHARE_AGG year, c(l l )  lcolor(red red)  lpattern(solid dash ) msymbol(none none) lwidth(thick thick) ytitle("") xlabel(2006 2021) xtitle("") legend(ring(0) pos(2) col(1)) 
graph export Fig3.png, replace
scatter elasticity_W COSTSHARE_AGG year, c(l l )  lcolor(black black)  lpattern(solid dash ) msymbol( none none ) lwidth(thick thick) ytitle("") xlabel(2006 2021) xtitle("") legend(ring(0) pos(2) col(1)) 
...
scatter gamma_RTS1 gamma_RTS2 year , c(l l) lcolor(green green) ysc(r(.95 1.1)) lpattern(solid dash) yline(1) msymbol(none none) lwidth(thick thick) ytitle("") xlabel(2006 2021) xtitle("") legend(ring(0) col(1) pos(2) ) 
graph export Fig4.png, replace
scatter gamma_RTS1 gamma_RTS2 year , c(l l) lcolor(black black) ysc(r(.95 1.1)) lpattern(solid dash) yline(1) msymbol(none none) lwidth(thick thick) ytitle("") xlabel(2006 2021) xtitle("") legend(ring(0) col(1) pos(2) ) 
