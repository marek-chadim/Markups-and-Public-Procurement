...
gen betahat_dp = _b[cogs]+2*_b[cogs2]*cogs+_b[k1cogs1]*k
...
gen betahat_dlw = cogs_tl+2*cogs2_tl*cogs+kcogs_tl*k
gen muhat_dlw = betahat_dlw/alphahat
*-------------------------------------------------------------------------------*
sum betahat*
